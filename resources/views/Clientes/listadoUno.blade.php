...
<body>
    ...
    <table style="width: 99%; margin: auto" class="table table-dark table-striped-columns">
        ...
        <tbody>
            ...
            <tr>
                <th style="text-align: center" scope="row">{{$customer->id}}</th>
                <td style="text-align: center">{{$customer->nombreCliente}}</td>
                <td style="text-align: center">{{$customer->cedulaCliente}}</td>
                <td style="text-align: center">{{$customer->direccionCliente}}</td>
                <td style="text-align: center">{{$customer->telefonoCliente}}</td>
                <td style="text-align: center">{{$customer->generoCliente}}</td>
                <td style="text-align: center"><img src="{{ asset('images/clientes/' . $customer->fotoCliente) }}" alt="Foto de {{$customer->nombreCliente}}" class="img-thumbnail" 
