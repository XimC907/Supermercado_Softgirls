...
<body>
    ...
    <table style="width: 99%; margin: auto" class="table table-dark table-striped-columns">
        ...
        <tbody>
            ...
            <tr>
                <th style="text-align: center" scope="row">{{$a->id}}</th>
                <td style="text-align: center">{{$a->nombreCliente}}</td>
                <td style="text-align: center">{{$a->cedulaCliente}}</td>
                <td style="text-align: center">{{$a->direccionCliente}}</td>
                <td style="text-align: center">{{$a->telefonoCliente}}</td>
                <td style="text-align: center">{{$a->generoCliente}}</td>
                <td style="text-align: center"><img src="{{ asset('images/clientes/' . $a->fotoCliente) }}" alt="Foto de {{$a->nombreCliente}}" class="img-thumbnail" 
